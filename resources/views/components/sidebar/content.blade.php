<x-perfect-scrollbar as="nav" aria-label="main" class="flex flex-col flex-1 gap-3 px-3">
    ...
    @can('product_access')
        ...
        <x-sidebar.dropdown title="{{ __('Products') }}" :active="request()->routeIs([
            ...
            @can('warehouse_access')
                <x-sidebar.sublink title="{{ __('Warehouses and Stores') }}" href="{{ route('warehouses.index') }}" :active="request()->routeIs('warehouses.index')" />
            @endcan
    ...
    @endcan
{{--    @can('warehouse_access')--}}
{{--        <x-sidebar.dropdown title="{{ __('Warehouses and Stores') }}" :active="request()->routeIs('warehouses.index')">--}}
{{--            <x-slot name="icon">--}}
{{--                <span class="inline-block mx-4">--}}
{{--                    <i class="fas fa-home-alt w-5 h-5"></i>--}}
{{--                </span>--}}
{{--            </x-slot>--}}
{{--            <x-sidebar.sublink title="{{ __('Warehouses and Stores') }}" href="{{ route('warehouses.index') }}" :active="request()->routeIs('warehouses.index')" />--}}
{{--        </x-sidebar.dropdown>--}}
